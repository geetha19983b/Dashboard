...
namespace DashBoard.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ResetPasswd(string UserName, string Password)
        {
            ...
            {
                TempData["msg"] = "<script>alert('Select User Name and Provide New Passwd !');</script>";
            }
            else
            {
                ...
                TempData["msg"] = "<script>alert('Password Reset Successfully !');</script>";
